...
public class MallocImpl extends Malloc {
    ...
    public MallocImpl(long capacity) {
    ...
    public MallocImpl(long base, long capacity) {
        this.base = base;
        this.capacity = capacity & ~7;
    ...
    public MallocImpl(MappedFile mmap) {
    ...
    public long malloc(int size) {
        ...
        throw new OutOfMemoryRuntimeException("Failed to allocate " + size + " bytes in heap malloc");
    }

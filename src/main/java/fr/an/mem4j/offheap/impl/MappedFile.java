...
/**
 * modified from https://github.com/odnoklassniki/one-nio.git
 * 
 */
@SuppressWarnings("restriction")
public class MappedFile implements Closeable {
    
    private static final Method map0 = JavaInternals.getMethod(sun.nio.ch.FileChannelImpl.class, "map0", int.class, long.class, long.class);
    private static final Method unmap0 = JavaInternals.getMethod(sun.nio.ch.FileChannelImpl.class, "unmap0", long.class, long.class);
